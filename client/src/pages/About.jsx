...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto text-2xl'>
      <h1 className='text-4xl font-bold mb-4 text-grey-800'>Pittner Györgyné Judit vagyok</h1>
...
<br/>
Célom az ingatlan-eladók, érdeklődők, majd később vásárlók maximális kiszolgálása elképzeléseik megvalósításában, végül a mindkét fél érdekeit magában foglaló Adásvételi Szerződés aláírása.
<br/>
